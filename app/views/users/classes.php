            ...
            <div class="col-lg-6">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="alert alert-primary bg-primary text-light border-0 alert-dismissible fade show" role="alert">
                    <strong>Select And Add Class</strong>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>
                  <form id="add-class">
                    <div class="my-3">
                      <select class="form-control form-control-lg" name="classname" required>
                        <option value="">Select Class</option>
                        <?php if (empty($data['classes2'])) : ?>
                          <option value="">No added class</option>
                        <?php else : ?>
                          <?php foreach ($data['classes2'] as $klass) : ?>
                            <option value="<?php echo $klass->classname; ?>"><?php echo $klass->classname; ?></option>
                          <?php endforeach; ?>
                        <?php endif; ?>
                      </select>
                    </div>
                    <div class="d-grid">
                      <input type="submit" id="submit" value="Add Class" class="btn btn-outline-primary">
                    </div>
                  </form>
