...
<body>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Enter your Pass key to login</p>
                                    </div>

                                    <form class="row g-3">

                                        <div class="col-12">
                                            <label for="yourUsername" class="form-label">PassKey</label>
                                            <div class="input-group has-validation">
                                                <span class="input-group-text" id="inputGroupPrepend">@</span>
                                                <input type="input" name="passkey" class="form-control" value="" id="yourUsername">
    ...
    <script>
        $('form').on('submit', function(event) {
            ...
            $.ajax({
                url: "<?php echo URLROOT; ?>/students/login",
                method: "POST",
